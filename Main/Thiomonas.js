...
// Fetch the data from the EDGAR_Thiomonas.json file inside the 'newicks' folder
fetch('newicks/EDGAR_Thiomonas.json')
  ...
  .catch(error => {
      ...
      document.getElementById('container').innerHTML = 'Failed to load the tree data. Please try again later.';
  });
